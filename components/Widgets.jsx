...
const Widgets = ({newResults, randomUsersResults}) => {
  ...
  return (
    <div className="xl:w-[600px] hidden lg:inline ml-8 space-y-5">
      ...
      <div className="text-gray-700 spase-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:w-[75%]">
      ...
      <div className="text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[90%] xl:w-[75%]">
        ...
        {randomUsersResults.slice(0, randomUserNumber).map((randomUser) => (
          ...
          <div  className="flex items-center px-4 py-2 cursor-pointer hover:bg-gray-200 transition duration-500 ease-out">
            ...
            <button className="ml-auto bg-black text-white rounded-full text-sm px-3.5 px-1.5 font-bold">Follow</button>
          </div>
          </motion.div>
        ))}
        </AnimatePresence>
